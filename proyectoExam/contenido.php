<?php
		...
		session_start();
			...
			if(isset($_POST['nombrePerf'])){
			
				if(strlen($_POST['nombrePerf'])!=0){
					
				$_SESSION['Jugador']->setNombre($_POST['nombrePerf']);
				$_SESSION['Jugador']->setApellido($_POST['apellidoPerf']);
				$_SESSION['Jugador']->setEdad($_POST['edadPerf']);
				$_SESSION['Juego']->setIdioma($_POST['idiomaPerf']);
				$_SESSION['Juego']->setJuego($_POST['juegoPerf']);
				
				}else{
					header('Location: perfil.php');
					alert("Te faltan datos cabronzazooo!!");
		...
		//var_dump($_SESSION['Jugador']->getPuntos());
